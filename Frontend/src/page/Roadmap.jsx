...
const roadmapItems = [
  {
    ...
    description:
      "Launch of the initial platform with essential ledger features.",
    features: [
  ...
  },
  {
    ...
    description:
      "Deep dive into financial health with better visualization tools.",
    features: [
  ...
  return (
    <div className="flex flex-col min-h-screen pt-16 bg-background">
      ...
      <section className="py-16 px-4 text-center max-w-4xl mx-auto">
        ...
        >
          See what we've built, what we're working on right now, and what's
          coming next to make Cash Book even better.
        </motion.p>
      </section>
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Header Group */}
                    <div
                      className={`flex items-center gap-4 mb-5 w-full ${isEven ? "flex-row-reverse justify-start" : "flex-row justify-start"}`}
                    >
                      <div
                        className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${item.bg} ${item.color}`}
                      >
                      ...
                      >
                        <span
                          className={`text-[10px] font-bold uppercase tracking-widest ${item.color} mb-0.5`}
                        >
                    ...
                    <p
                      className={`text-muted-foreground text-sm leading-relaxed mb-6 w-full ${isEven ? "text-right" : "text-left"}`}
                    >
                      {item.description}
                    </p>

                    <ul
                      className={`space-y-3 w-full flex flex-col ${isEven ? "items-end" : "items-start"}`}
                    >
                      {item.features.map((feature, fIndex) => (
                        <li
                          key={fIndex}
                          className={`flex items-center gap-3 text-sm font-medium text-foreground/80 ${isEven ? "flex-row-reverse" : "flex-row"}`}
                        >
                  ...
                  <div
                    className={`hidden md:block w-[48%] ${isEven ? "order-3" : "order-1"}`}
                  />
