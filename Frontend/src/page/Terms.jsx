        ...
        <div className="max-w-3xl mx-auto">
          <div className="prose prose-invert max-w-none text-muted-foreground">
            <p className="text-lg leading-relaxed mb-8 text-foreground/90">
              Welcome to Cash Book. These Terms of Service outline the rules and
              regulations for the use of our website and mobile application. By
              accessing this service we assume you accept these terms and
              conditions in full. Do not continue to use Cash Book if you do not
            ...
            <ul className="list-disc pl-6 space-y-2 mb-8">
              <li>
                <strong>"Service"</strong> refers to the Cash Book application
                and website.
              </li>
              <li>
                <strong>"User", "You", and "Your"</strong> refers to you, the
                person accessing this Service and accepting the Company's terms.
              </li>
              <li>
                <strong>
                  "The Company", "Ourselves", "We", "Our" and "Us"
                </strong>
                , refers to Cash Book Inc.
              </li>
            </ul>
            ...
            <p className="mb-4">
              Unless otherwise stated, Cash Book and/or its licensors own the
              intellectual property rights for all material on Cash Book. All
              intellectual property rights are reserved. You may view and/or
              print pages from our service for your own personal use subject to
              restrictions set in these terms and conditions.
            </p>
            <p className="mb-8">You must not:</p>
            <ul className="list-disc pl-6 space-y-2 mb-8">
              ...
              <li>
                Redistribute content from Cash Book (unless content is
            ...
            <p className="mb-8">
              ...
              password. We reserve the right to refuse service, terminate
            ...
            <p className="mb-8">
              In no event shall Cash Book, nor any of its officers, directors,
              and employees, be liable to you for anything arising out of or in
              any way connected with your use of this Service, whether such
              liability is under contract, tort or otherwise. Cash Book,
              including its officers, directors, and employees, shall not be
              liable for any indirect, consequential, or special liability
              arising out of or in any way related to your use of this Service.
            </p>
            ...
            <p className="mb-8">
              ...
              the laws of the State/Country in which Cash Book is officially
              registered, and you submit to the non-exclusive jurisdiction of
              the state and federal courts located in that jurisdiction for the
