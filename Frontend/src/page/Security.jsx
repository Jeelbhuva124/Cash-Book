...
import { ShieldCheck, Lock, Key, EyeOff, Server, Database, ArrowRight, Activity, Fingerprint } from 'lucide-react';
...
const FeatureCard = ({ icon: Icon, title, description, index }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col rounded-[2rem] border border-border bg-card/30 px-8 py-8 shadow-sm backdrop-blur-xl overflow-hidden hover:shadow-2xl transition-shadow duration-500 cursor-crosshair"
    >
    ...
    <div className="min-h-screen bg-background relative overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          >
            We implement military-grade zero-knowledge encryption across all enterprise databases. Data remains entirely encrypted — meaning not even our highest-level administrators can access your sensitive information.
          </motion.p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-24">
          {[
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false, amount: 0.3 }}
              transition={{ delay: 0.4 + (idx * 0.15), duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
        ...
        <motion.div 
          ...
          className="relative rounded-[3rem] bg-card/50 backdrop-blur-xl border border-border p-12 md:p-16 text-center overflow-hidden shadow-2xl"
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed">
              Our dedicated security engineering team is available to discuss our architecture, encryption standards, and compliance in detail.
            </p>
            <motion.a 
