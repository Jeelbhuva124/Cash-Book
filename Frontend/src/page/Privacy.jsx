        ...
        <div className="max-w-3xl mx-auto">
          <div className="prose prose-invert max-w-none text-muted-foreground">
            ...
            <p className="text-lg leading-relaxed mb-8 text-foreground/90">
              At Cash Book, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our mobile application. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
            </p>

            <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">1. Collection of Your Information</h2>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-8">
              ...
              <li><strong>Financial Data:</strong> Data related to your transactions, account balances, and business ledgers that you input into the Cash Book platform. This data is heavily encrypted.</li>
            ...
            <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">2. Use of Your Information</h2>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-8">
              ...
              <li>Improve our application functionality based on usage analytics.</li>
              <li>Increase the efficiency and operation of the Site.</li>
            </ul>

            <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">3. Disclosure of Your Information</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">4. Security of Your Information</h2>
            <p className="mb-8">
              We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
            </p>

            <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">5. Contact Us</h2>
            <p className="mb-4">
              If you have questions or comments about this Privacy Policy, please contact us at:
            </p>
            <div className="bg-card border border-border p-6 rounded-xl mt-4">
              <p className="font-semibold text-foreground">Cash Book Legal Team</p>
