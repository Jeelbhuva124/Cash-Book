...
import { Search, Book, Shield, Zap, CreditCard, Settings, Users, FileText } from 'lucide-react';
import { Link } from 'react-router-dom';

const categories = [
  {
    title: "Getting Started",
    description: "Learn the basics and set up your Cash Book account in minutes.",
    icon: Zap,
    color: "text-blue-500",
    bg: "bg-blue-500/10",
    articles: 12
  ...
  {
    title: "Billing & Plans",
    description: "Understand our pricing, premium features, and payment methods.",
    icon: CreditCard,
  ...
  {
    title: "Transactions",
    description: "Everything you need to know about recording and managing entries.",
    icon: Book,
  ...
  },
  {
    ...
    description: "How to generate, download, and interpret your financial reports.",
    icon: FileText,
    color: "text-rose-500",
    bg: "bg-rose-500/10",
    articles: 9
  },
  {
    ...
    description: "Collaborate with your team, assign roles, and manage permissions.",
    icon: Users,
    color: "text-cyan-500",
    bg: "bg-cyan-500/10",
    articles: 6
...
export const HelpCenter = () => {
  return (
    <div className="flex flex-col min-h-screen pt-16 bg-background">
      ...
      <section className="py-24 px-4 text-center bg-card border-b border-border/50">
      ...
      <section className="py-20 px-4 flex-grow">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground">Browse Topics</h2>
            <p className="text-muted-foreground mt-4">Explore our comprehensive guides to master Cash Book.</p>
          </div>
      ...
      <section className="py-16 bg-card border-t border-border/50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8">Our support team is always ready to help you with any issues.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/contact" className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-primary text-primary-foreground font-bold hover:opacity-90 transition-opacity shadow-lg shadow-primary/20">
              Contact Support
            </Link>
            <Link to="/faq" className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-background border border-border text-foreground font-bold hover:bg-muted transition-colors">
              Read FAQs
            </Link>
          </div>
        </div>
