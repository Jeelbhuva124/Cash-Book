  ...
  return (
    <div className="flex flex-col min-h-screen pt-16 bg-background">
      <section className="py-20 px-4 text-center max-w-4xl mx-auto">
        ...
        >
          Discover our suite of financial tools designed to give you complete control over your money.
        </motion.p>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, i) => (
              ...
              >
                ...
                <Link to="/signup" className="inline-flex items-center gap-2 text-sm font-bold text-primary hover:gap-3 transition-all">
