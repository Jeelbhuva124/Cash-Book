...
const legalDocuments = [
  {
    ...
    description: "The rules, guidelines, and agreements for using the Cash Book platform and services.",
    icon: Scale,
    link: "/terms",
  ...
  },
  {
    ...
    description: "How we collect, use, and protect your personal data and financial information.",
    icon: ShieldCheck,
    link: "/privacy",
    date: "Last updated: July 2026"
  },
    ...
    <div className="flex flex-col min-h-screen pt-16 bg-background">
      ...
      <section className="py-24 px-4 text-center bg-card border-b border-border/50">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Transparency and trust are fundamental to Cash Book. Here you can find all our legal documents, policies, and terms governing your use of our services.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 flex-grow">
        <div className="max-w-5xl mx-auto sm:px-6 lg:px-8">
          ...
          >
            ...
            <div>
              <h4 className="text-sm font-bold text-amber-500 mb-1">Legal Disclaimer</h4>
              <p className="text-sm text-amber-500/80 leading-relaxed">
                The information provided on this page and within our legal documents does not constitute legal advice. By using Cash Book, you agree to be bound by the terms outlined in these documents. We reserve the right to update these policies periodically.
              </p>
            </div>
          </motion.div>
