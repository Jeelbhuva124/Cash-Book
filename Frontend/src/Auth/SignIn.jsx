      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 xl:p-24 bg-white">
        <div className="w-full max-w-[420px] space-y-8">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-extrabold text-slate-900">Login to Daily Chalan</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between ml-0.5">
                <label className="text-xs font-bold tracking-wider text-slate-500 uppercase">Access Key</label>
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink-0 mx-4 text-[10px] font-bold tracking-widest uppercase text-slate-400">Or continue with</span>
            <div className="flex-grow border-t border-slate-100"></div>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2.5 py-3.5 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 transition-colors font-semibold text-xs uppercase tracking-wider text-slate-700 disabled:opacity-75"
          >
